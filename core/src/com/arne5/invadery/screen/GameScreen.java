package com.arne5.invadery.screen;

import com.arne5.invadery.Assets;

import com.arne5.invadery.Entity.EntityManager;
import com.arne5.invadery.Entity.Player;
		...
		public void render(SpriteBatch sb)
			{
				...
				scoreFont.draw(sb, layout, InvaderY.WIDTH / 2 - 20, InvaderY.HEIGHT - layout.height);
				layout.setText(lifeFont, "Lives Left " + entityManager.playerLives);

				lifeFont.draw(sb, layout,  10 , InvaderY.HEIGHT - layout.height);
				layout.setText(levelFont, "Level " + entityManager.level);
				levelFont.draw(sb,layout, 10 , InvaderY.HEIGHT - lifeFont.getXHeight() -layout.height*2 );

				layout.setText(highScoreFont, "HighScore " + Gdx.app.getPreferences("GamePref").getInteger("HighScore") );

				highScoreFont.draw(sb,layout, 10 , InvaderY.HEIGHT - lifeFont.getXHeight() -layout.height*2 - scoreFont.getXHeight()*2 );

		...
		public void render(SpriteBatch sb)
			{
				...
				sb.draw(sprite, InvaderY.WIDTH / 2 - sprite.getWidth() / 2, InvaderY.HEIGHT / 2 - sprite.getHeight() / 2);
				layout.setText(highScoreFont, "HighScore "+ Gdx.app.getPreferences("GamePref").getInteger("HighScore"));

				highScoreFont.draw(sb,layout, 10 , InvaderY.HEIGHT - highScoreFont.getXHeight() -layout.height*2 );

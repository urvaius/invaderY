...
import com.arne5.invadery.screen.*;
						...
						for(int i=0;i <amount;i++)
							{
								...
								float y = MathUtils.random(InvaderY.HEIGHT, InvaderY.HEIGHT *3);
				...
				if(runLevel2)
					{
						for(int i=0;i <10;i++)
							{
								float x = MathUtils.random(0,InvaderY.WIDTH-Assets.greenEnemy.getWidth());
								float y = MathUtils.random(InvaderY.HEIGHT,InvaderY.HEIGHT*3);
								float speed = MathUtils.random(2,5);

package com.arne5.invadery.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(InvaderY.WIDTH, InvaderY.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(InvaderY.WIDTH, InvaderY.HEIGHT);
